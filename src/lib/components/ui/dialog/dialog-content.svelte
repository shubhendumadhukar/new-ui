...
<Dialog.Portal>
  <Dialog.Overlay />
  <DialogPrimitive.Content {transition} {transitionConfig} class={cn("fixed top-0 left-0 h-full max-h-screen z-50 grid w-full gap-4 border bg-background p-2 shadow-lg", className)} {...$$restProps}>
    <slot />
